...
public class Cache<T> {
    ...
    public T get(String key) {
        if (isNotEmpty(key, true)) {
            return JSON.parseObject(sp.getString(getTrimedString(key), null), clazz);
        }
    ...
    public void remove(String key) {
        ...
        } else sp.edit().remove(getTrimedString(key)).apply();

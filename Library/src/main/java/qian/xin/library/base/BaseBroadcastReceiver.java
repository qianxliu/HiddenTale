...
public abstract class BaseBroadcastReceiver extends BroadcastReceiver {
    ...
    public BaseBroadcastReceiver(AppCompatActivity context) {
     ...
     * @return
     */
    public static BroadcastReceiver register(AppCompatActivity context, @Nullable BroadcastReceiver receiver, String action) {
     ...
     * @return
     */
    public static BroadcastReceiver register(AppCompatActivity context, @Nullable BroadcastReceiver receiver, String[] actions) {
     ...
     * @return
     */
    public static BroadcastReceiver register(AppCompatActivity context, @Nullable BroadcastReceiver receiver, List<String> actionList) {
     ...
     * @return
     */
    public static BroadcastReceiver register(AppCompatActivity context, @Nullable BroadcastReceiver receiver, IntentFilter filter) {
        Log.i(TAG, "register >>>");
     ...
     * @return
     */
    public static void unregister(AppCompatActivity context, BroadcastReceiver receiver) {

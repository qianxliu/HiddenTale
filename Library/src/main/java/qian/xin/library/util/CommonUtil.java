...
public class CommonUtil {
    ...
    public static void toMessageChat(Activity context, List<String> phoneList) {
        ...
        for (int i = 0; i < phoneList.size(); i++) {
            phones.append(phoneList.get(i)).append(";");
        }
        toMessageChat(context, phones.toString());
    }
     ...
     * @param value
     */
    public static void copyText(Activity context, String value) {
     ...
     * @param context
     */
    public static void showShortToast(final Activity context, int stringResId) {
        try {
     ...
     * @param string
     */
    public static void showShortToast(final Activity context, final String string) {
     ...
     */
    public static void showShortToast(final Activity context, final String string, final boolean isForceDismissProgressDialog) {
        if (context == null) {
            return;
        }

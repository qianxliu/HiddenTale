...
public class ServerSettingActivity extends BaseActivity implements OnClickListener, OnBottomDragListener {
     ...
     * @return
     */
    public static Intent createIntent(AppCompatActivity context, String normalAddress, String testAddress) {
     ...
     * @return
     */
    public static Intent createIntent(AppCompatActivity context, String address, String sharedPreferencesPath, int pathMode, String key) {

...
import qian.xin.library.util.ContactUtil;
...
public class EditTextInfoWindow extends BaseBottomWindow implements OnClickListener {
    ...
    public static Intent createIntent(AppCompatActivity context, String key, String value) {
        return createIntent(context, key, value, "qian.xin.library");
    }
     ...
     * @return
     */
    public static Intent createIntent(AppCompatActivity context, String key, String value, String packageName) {
    ...
    public static Intent createIntent(AppCompatActivity context, int type, String key, String value) {
        return createIntent(context, type, key, value, "qian.xin.library");
    }
     ...
     * @return
     */
    public static Intent createIntent(AppCompatActivity context, int type, String key, String value, String packageName) {
    ...
    public void onForwardClick(View v) {
        editedValue = getTrimedString(tvEditTextInfoPlace) + getTrimedString(etEditTextInfo);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_TO_PLACE_PICKER) {
            ...
            tvEditTextInfoPlace.setText(place.toString());
        }
    }

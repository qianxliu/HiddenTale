 ...
 */
public class TopMenuWindow extends AppCompatActivity implements OnItemClickListener, OnClickListener {
     ...
     * @return
     */
    public static Intent createIntent(AppCompatActivity context, String[] names, ArrayList<Integer> intentCodeList) {
        return new Intent(context, TopMenuWindow.class).
                putExtra(INTENT_NAMES, names).

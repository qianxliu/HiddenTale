...
public class DatePickerWindow extends BaseViewBottomWindow<List<Entry<Integer, String>>, GridPickerView> {
     ...
     * @return
     */
    public static Intent createIntent(AppCompatActivity context, int[] limitYearMonthDay) {
     ...
     * @return
     */
    public static Intent createIntent(AppCompatActivity context, int[] limitYearMonthDay, int[] defaultYearMonthDay) {
     ...
     * @return
     */
    public static Intent createIntent(AppCompatActivity context, int[] minYearMonthDay, int[] maxYearMonthDay, int[] defaultYearMonthDay) {
            ...
            runUiThread(() -> {
                ...
                if (tabPosition < 2) {
                    ...
                    if (selectedList != null && selectedList.size() >= 3) {
                        ...
                        if (TimeUtil.isLeapYear(parseInt(
    ...
    private ArrayList<GridPickerConfig> configList = new ArrayList<>();
    ...
    public void initData() {//必须调用
        ...
        if (minDateDetails.length != maxDateDetails.length) {
            finish();
            return;
        }
    ...
    protected void setResult() {
        ...
        if (list != null && list.size() >= 3) {
            ...
            for (int i = 0; i < list.size(); i++) {
                detailList.add(parseInt(StringUtil.getNumber(list.get(i))));
            }

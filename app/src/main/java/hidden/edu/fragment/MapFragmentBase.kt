...
abstract class MapFragmentBase : Fragment(), LocationSource, AMapLocationListener, OnPoiSearchListener, CompoundButton.OnCheckedChangeListener, OfflineMapDownloadListener {
    ...
    abstract var cameraPosition: CameraPosition?
    ...
    override fun onLocationChanged(amapLocation: AMapLocation) {
        ...
        initPoiSearch(aMap!!.myLocation.latitude, aMap!!.myLocation.longitude)
    }

    private fun initPoiSearch(lat: Double, lon: Double) {
        if (mPoiSearch == null) {
            val poiQuery = PoiSearch.Query("", "", "陕西省")

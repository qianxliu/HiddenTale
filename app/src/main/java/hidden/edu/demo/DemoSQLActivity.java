...
public class DemoSQLActivity extends BaseActivity implements OnClickListener, OnBottomDragListener {
    ...
    private void printAll() {
        runUiThread(() -> etDemoSQLQueryColumn.setText(""));
        runThread(TAG + "printAll", () -> print("", getString(sqlHelper)));
    }
    ...
    private void query() {
        ...
        runThread(TAG + "query", () -> print(getString(sqlHelper)));
    }
    ...
    private String getString(SQLHelper sqlHelper) {
        ...
        for (ContentValues values : list) {
            s.append(getString(values)).append(",");
        }
        return s.append("\n}").toString();
    }
    ...
    private String getString(ContentValues values) {
        ...
        for (String key : values.keySet()) {
            s.append("    ").append(key).append(":").append(values.get(key)).append(",\n");
        }

...
import qian.xin.library.base.BaseHttpRecyclerActivity;
...
public class DemoHttpRecyclerActivity extends BaseHttpRecyclerActivity<User, UserView, UserAdapter> implements OnBottomDragListener {
     ...
     * 启动这个Activity的Intent
     */
    public static Intent createIntent(AppCompatActivity context, int range) {
    ...
    public void getListAsync(final int page) {
        ...
        //仅测试用<<<<<<<<<<<
        new Handler().postDelayed(() -> onHttpResponse(-page, page >= 5 ? null : JSON.toJSONString(TestUtil.getUserList(page, 10)), null), 1000);
        //仅测试用>>>>>>>>>>>>
    }

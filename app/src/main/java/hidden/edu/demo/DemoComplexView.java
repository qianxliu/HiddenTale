 ...
 *
 * @author Lemon
 * @use <br> DemoComplexView DemoComplexView = new DemoComplexView(context, resources);
...
public class DemoComplexView extends BaseView<Entry<String, String>> implements OnClickListener {
    ...
    DemoComplexView(AppCompatActivity context) {
    ...
    private TextView tvDemoComplexViewName;
    private TextView tvDemoComplexViewNumber;
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.tvDemoComplexViewName) {

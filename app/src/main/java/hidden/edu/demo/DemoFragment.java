...
public class DemoFragment extends BaseFragment {
     ...
     * 创建一个Fragment实例
     */
    static DemoFragment createInstance(long userId) {
     ...
     * 创建一个Fragment实例
     */
    private static DemoFragment createInstance(long userId, String userName) {
     ...
     * 示例方法：获取号码列表
     */
    //private List<Entry<String, String>> getList(long userId) {
    private List<Entry<String, String>> getList() {
        list = new ArrayList<>();
        for (int i = 0; i < 64; i++) {
    ...
    public void initEvent() {//必须在onCreateView方法内调用
        ...
        lvDemoFragment.setOnItemClickListener((parent, view, position, id) -> {

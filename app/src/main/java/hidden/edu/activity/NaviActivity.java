...
public class NaviActivity extends Activity implements AMapNaviListener, AMapNaviViewListener {
    ...
    AMapNavi mAMapNavi;
    //算路终点坐标
    public static NaviLatLng mEndLatlng = new NaviLatLng();
    //算路起点坐标
    ...
    public static Intent createIntent(Activity context) {
        return new Intent(context, NaviActivity.class);
    }
    ...
    public void toActivity(final Intent intent, final int requestCode, final boolean showAnimation) {
        runOnUiThread(() -> {
            if (intent == null) {
                Log.w("NaviActivity", "toActivity  intent == null >> return;");
                return;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStartLatlng = new AMapNaviLocation().getCoord();
